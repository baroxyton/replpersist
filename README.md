...
- it's super leightweight. It only takes up 3.45kb unpacked and 1.6kb packed. In fact, it got 71% leighter in the latest update. In conparison, replits official node database client is 160kb, and this documentation is 3kb+
